...
<header class="relative h-screen flex items-center justify-center overflow-hidden clip-path-wave mb-12">
    ...
    <div class="relative z-10 text-center px-4 max-w-4xl mx-auto mt-16">
        <span class="inline-block py-1 px-3 rounded-full bg-orange-500/20 border border-orange-400 text-orange-100 text-sm font-bold tracking-widest uppercase mb-6 backdrop-blur-sm animate-pulse">Most Popular Choice</span>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="flex justify-center mb-12">
            <div class="bg-white p-1 rounded-full shadow-md inline-flex">
                <button onclick="switchDay(1)" id="tab-day1" class="px-8 py-3 rounded-full font-bold transition-all duration-300 bg-green-900 text-white">Day 1: Arrival & Culture</button>
                <button onclick="switchDay(2)" id="tab-day2" class="px-8 py-3 rounded-full font-bold transition-all duration-300 text-gray-600 hover:bg-gray-100">Day 2: Deep Safari</button>
            </div>
        </div>
...
<script>
    function switchDay(day) {
        ...
        if(day === 1) {
            ...
            tab1.classList.add('bg-green-900', 'text-white');
            tab1.classList.remove('text-gray-600', 'hover:bg-gray-100');
            tab2.classList.remove('bg-green-900', 'text-white');
            tab2.classList.add('text-gray-600', 'hover:bg-gray-100');
        } else {
            ...
            tab2.classList.add('bg-green-900', 'text-white');
            tab2.classList.remove('text-gray-600', 'hover:bg-gray-100');
            tab1.classList.remove('bg-green-900', 'text-white');
            tab1.classList.add('text-gray-600', 'hover:bg-gray-100');
        }
    }
</script>
