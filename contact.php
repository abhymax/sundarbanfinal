...
<header class="relative h-[50vh] min-h-[400px] bg-[#051105] flex flex-col items-center justify-center text-center text-white overflow-hidden">
    ...
    <div class="relative z-10 max-w-2xl mx-auto px-4">
        <span class="text-tiger-orange font-bold tracking-widest uppercase text-sm mb-4 block"><?php echo htmlspecialchars($hero['cta_text']); ?></span>
        <h1 class="text-5xl md:text-7xl font-serif font-bold mb-6"><?php echo htmlspecialchars($hero['title']); ?></h1>
        <p class="text-gray-300 text-lg font-light max-w-xl mx-auto leading-relaxed"><?php echo htmlspecialchars($hero['subtitle']); ?></p>
    </div>
</header>

<section class="relative -mt-20 pb-24 px-4 z-20">
    <div class="max-w-6xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
        
        <div class="md:w-2/5 bg-safari-green text-white p-10 md:p-12 relative overflow-hidden flex flex-col justify-between">
            <div class="relative z-10 space-y-12">
                <div>
                    <h3 class="text-3xl font-bold font-serif mb-4 text-white"><?php echo htmlspecialchars($intro['title']); ?></h3>
                    <p class="text-green-100/80 font-light leading-relaxed"><?php echo htmlspecialchars($intro['subtitle']); ?></p>
                </div>
                    
                <div class="space-y-8">
                    <div class="flex items-start gap-5 group">
                        <div class="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center shrink-0 text-tiger-orange group-hover:bg-tiger-orange group-hover:text-safari-green transition-colors duration-300"><span class="material-symbols-outlined text-xl">call</span></div>
                        <div>
                            <p class="text-xs text-green-300/70 uppercase tracking-widest font-bold mb-1">Phone</p>
                            <a href="tel:<?php echo htmlspecialchars($settings['phone']); ?>" class="text-lg font-medium hover:text-tiger-orange transition"><?php echo htmlspecialchars($settings['phone']); ?></a>
                        </div>
                    </div>

                    <div class="flex items-start gap-5 group">
                        <div class="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center shrink-0 text-tiger-orange group-hover:bg-tiger-orange group-hover:text-safari-green transition-colors duration-300"><span class="material-symbols-outlined text-xl">mail</span></div>
                        <div>
                            <p class="text-xs text-green-300/70 uppercase tracking-widest font-bold mb-1">Email</p>
                            <a href="mailto:<?php echo htmlspecialchars($settings['email']); ?>" class="text-lg font-medium hover:text-tiger-orange transition break-all"><?php echo htmlspecialchars($settings['email']); ?></a>
                        </div>
                    </div>

                    <div class="flex items-start gap-5 group">
                        <div class="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center shrink-0 text-tiger-orange group-hover:bg-tiger-orange group-hover:text-safari-green transition-colors duration-300"><span class="material-symbols-outlined text-xl">location_on</span></div>
                        <div>
                            <p class="text-xs text-green-300/70 uppercase tracking-widest font-bold mb-1">Office</p>
                            <p class="text-lg font-medium leading-snug"><?php echo nl2br(htmlspecialchars($settings['address'])); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="md:w-3/5 p-8 md:p-16 bg-white">
            <div class="mb-8">
                <h2 class="text-3xl font-bold font-serif text-gray-800">Send us a Message</h2>
            </div>
            ...
            <form id="contact-form" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="tel" name="phone" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-tiger-orange focus:bg-white transition-all">
                    </div>
                </div>
                ...
                <div class="bg-orange-50 p-4 rounded-xl border border-orange-100 flex items-center justify-between">
                    <div class="flex items-center gap-2 text-gray-700 font-bold text-sm">
                        <span class="material-symbols-outlined text-tiger-orange">security</span>
                        <span>Security Check: <?php echo "$n1 + $n2 = ?"; ?></span>
                    </div>
                ...
                <button type="submit" id="send-btn" class="w-full bg-tiger-orange text-black font-bold py-4 rounded-xl hover:bg-orange-400 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center gap-2">
...
<section class="h-[450px] w-full grayscale hover:grayscale-0 transition duration-700 border-t border-gray-200">
    <iframe 
